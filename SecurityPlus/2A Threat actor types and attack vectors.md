...
The sophisticated nature of modern cybersecurity threats means that it is important to be able to describe and analyze behaviors. This analysis involves identifying the attributes of [[threat actor]]s in terms of location, intent, and capability.
...
To fully assess intent and capability, it is helpful to identify different categories of [[threat actor]]s.
