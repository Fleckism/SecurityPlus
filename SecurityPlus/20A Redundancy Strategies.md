...
Cybersecurity resilience means that even successful intrusions by [[threat actor]]s have limited impact on [[confidentiality]], [[integrity]], and [[My linked notes/Dictionary/Availability]]. **Provisioning redundancy in storage, power, and network systems, plus effective backup procedures**, site resiliency, and effective procedures for change control and configuration management are crucial in maintaining high [[My linked notes/Dictionary/Availability]]. 
...
System [[My linked notes/Dictionary/Availability]] can refer to an overall process, but also to [[My linked notes/Dictionary/Availability]] at the level of a server or individual component.

### Scalability and Elasticity

High [[My linked notes/Dictionary/Availability]] also means that a system is able to cope with rapid growth in demand. Two properties of high [[My linked notes/Dictionary/Availability]] that have to do with this are referred to as scalability and elasticity. Scalability is the capacity to increase resources to meet demand within similar cost ratios. This means that if service demand doubles, costs do not more than double. There are two types of [[scalability]]:
